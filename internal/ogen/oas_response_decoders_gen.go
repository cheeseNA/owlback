...
func decodeGetTasksOfUserResponse(resp *http.Response) (res GetTasksOfUserRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetTasksOfUserOKApplicationJSON
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 401:
		// Code 401.
		return &GetTasksOfUserUnauthorized{}, nil
	case 404:
		// Code 404.
		return &GetTasksOfUserNotFound{}, nil
	case 500:
		// Code 500.
		return &GetTasksOfUserInternalServerError{}, nil
	}
	return res, validate.UnexpectedStatusCode(resp.StatusCode)
}
